...
-   Support RFC 6265 compliant cookie policy thanks to [Jonas
    Linde](https://github.com/krakan){.external-link}
...
-   make sure workspace exists before sending files, thanks
    to [ctran](https://github.com/ctran){.external-link}
...
-   Add support
    for[ jacoco-plugin](https://wiki.jenkins-ci.org/display/JENKINS/JaCoCo+Plugin){.external-link}
...
-   Support Coverage Report generated by [Clover
    plugin](https://wiki.jenkins-ci.org/display/JENKINS/Clover+Plugin){.external-link} and [Cobertura
    plugin](https://wiki.jenkins-ci.org/display/JENKINS/Cobertura+Plugin){.external-link}
...
-   Support Test Report generated
    by [cucumber-testresult-plugin](https://wiki.jenkins-ci.org/display/JENKINS/Cucumber+Test+Result+Plugin){.external-link}
-   FIXED TestNG Summary Display issue

### 1.2 (Oct 16, 2016)

-   Support Test Report generated by [TestNG
    plugin](https://wiki.jenkins-ci.org/display/JENKINS/testng-plugin){.external-link}
